                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                className="w-full bg-slate-100 dark:bg-black/20 border-slate-200 dark:border-white/5 rounded-2xl py-4 pl-12 pr-4 text-sm font-semibold transition-all focus:ring-1 focus:ring-primary outline-none"
                                type="text"
                                value={name}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <textarea
                                className="w-full bg-slate-100 dark:bg-black/20 border-slate-200 dark:border-white/5 rounded-2xl p-4 text-sm font-medium leading-relaxed transition-all focus:ring-1 focus:ring-primary outline-none"
                                rows={4}
                                value={bio}
