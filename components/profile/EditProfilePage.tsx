...
export default function EditProfilePage() {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-sans min-h-screen pb-32">
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md px-6 pt-12 pb-4 flex items-center justify-between border-b border-slate-100 dark:border-transparent">
                <button
                    onClick={() => router.back()}
            ...
            <main className="pt-32 px-6 pb-12 space-y-8">
                ...
                <div className="flex flex-col items-center">
                    <div className="relative group">
                        <div className="w-32 h-32 rounded-full border-4 border-white dark:border-surface-dark p-1 bg-gradient-to-tr from-primary to-primary/20 shadow-xl shadow-primary/10">
                            <img
                                alt="User Profile"
                        ...
                        <button className="absolute bottom-1 right-1 bg-primary text-white dark:text-background-dark w-10 h-10 rounded-full flex items-center justify-center border-4 border-white dark:border-surface-dark shadow-lg">
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                className="w-full bg-slate-100 dark:bg-surface-dark border-slate-200 dark:border-white/5 rounded-2xl py-4 pl-12 pr-4 text-sm font-semibold transition-all focus:ring-1 focus:ring-primary outline-none"
                                type="text"
                                value={name}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <textarea
                                className="w-full bg-slate-100 dark:bg-surface-dark border-slate-200 dark:border-white/5 rounded-2xl p-4 text-sm font-medium leading-relaxed transition-all focus:ring-1 focus:ring-primary outline-none"
                                rows={4}
                                value={bio}
