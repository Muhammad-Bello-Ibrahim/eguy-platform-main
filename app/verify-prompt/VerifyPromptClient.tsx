        ...
        const interval = setInterval(async () => {
            try {
                ...
                if (data.verified) {
                    ...
                    // Check if user enabled biometric during registration
                    const biometricPref = sessionStorage.getItem('register_biometric');
                    const canUseBiometric = isBiometricAvailable();

                    if (biometricPref === 'true' && canUseBiometric && data.userId) {
                        // Show biometric setup modal
                        setUserId(data.userId);
                        setShowBiometricSetup(true);
                        sessionStorage.removeItem('register_biometric');
                    } else {
